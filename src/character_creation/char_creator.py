...
#functions
def end_character_creation() -> str:
    """Ends character creation and changes screen.\n
    Returns a string (`str`)."""
    return "START_GAMEPLAY"
    ...
    while True:
        ...
        if CHAR_CURRENT_SCREEN == "RACE_SCREEN":
            ...
            if bio_ui.IS_NAME_SELECTED == False:
                ...
                data.export_player_mods(data.player_mods)
            ...
            if action is None:
                ...
                if CHAR_CURRENT_SCREEN == "RACE_SCREEN":
                    ...
                    for a in range(len(data.player_attributes)):
                        ...
                        data.player_attributes[a] += data.player_mods[a]
                    data.export_player_attributes(data.player_attributes)
                    data.export_player_mods(data.player_mods)
                    data.beget_player(data.player_data)
                    return 0
